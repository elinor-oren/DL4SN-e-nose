...
One of the standout successes of the E-Nose project was my significant growth in technical skills and confidence, particularly in areas that I found initially intimidating. Prior to this project, Python was an incredibly daunting tool. The necessity to clean and preprocess the data for modeling led to the development of a Python script capable of transforming raw sensor outputs into structured CSV files. While I still don't really know how to set up virtual environments (or honestly really how to use github push and pull commands), the successful creation and implementation of the data cleaning script and learning to using colabs felt like a significant milestone.
